...
const ResearchPaper = () => {
    return (
        <div className="flex flex-col gap-4 mb-20 justify-start  px-24">
            <h1 className="text-3xl text-center font-bold font-sans mb-20">researched by the college students</h1>
            <div>
                <h1 className="text-2xl font-bold font-sans">Social Science Research Network</h1>
                <p className="text-[18px] font-semibold font-sans"> Social Science Research Network is a website that provides access to academic papers in the social sciences and humanities.</p>
