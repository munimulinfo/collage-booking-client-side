        ...
        <div className="flex justify-center items-center mt-14 mb-12 ">
            <div className="card card-side bg-base-100 shadow-xl flex flex-col relative">
                ...
                <div className="card-body">
                    ...
                    <p><span className="font-bold">Birth-Date: </span>{singleuser?.birthdate}</p>
                    <p><span className="font-bold">Email: </span>{singleuser?.email}</p>
                    <p><span className="font-bold">University: </span>{singleuser?.university}</p>
                    <p><span className="font-bold">Address: </span>{singleuser?.address}</p>
                </div>
            </div>
