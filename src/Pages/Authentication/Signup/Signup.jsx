...
const Signup = () => {
    ...
    return (
        <div className='fles justify-center items-center gap-10 mb-24'>
            <div className='w-full lg:w-1/2 mx-auto lg:px-16'>
                <form onSubmit={handleSubmit(onSubmit)} className="w-full mt-28  shadow-xl mb-10 p-8 border border-purple-500 bg-white rounded-lg text-black">
